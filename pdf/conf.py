...
#   (master_doc, project, project, copyright),
    ('pdf/pdf_quickstart-guide', u'Mirantis-OpenStack-7.0-QuickStartGuide', u'QuickStart Guide', u'2015, Mirantis Inc.'),
    ('pdf/pdf_planning-guide', u'Mirantis-OpenStack-7.0-PlanningGuide', u'Planning Guide', u'2015, Mirantis Inc.'),
    ('pdf/pdf_user', u'Mirantis-OpenStack-7.0-UserGuide',  u'User Guide', u'2015, Mirantis Inc.'),
    ('pdf/pdf_operations', u'Mirantis-OpenStack-7.0-OperationsGuide', u'Operations Guide', u'2015, Mirantis Inc.'),
    ('pdf/pdf_monitoring-guide', u'Mirantis-OpenStack-7.0-MonitoringGuide', u'Monitoring Guide', u'2015, Mirantis Inc.'),
    ('pdf/pdf_reference', u'Mirantis-OpenStack-7.0-ReferenceArchitecture', u'Reference Architecture', u'2015, Mirantis Inc.'),
