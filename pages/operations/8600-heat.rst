...
This component is similar to *heat-api*,
but provides AWS CloudFormation compatible API.

heat-engine
+++++++++++

This is the main component of the Heat framework.
...
When using Fuel 4.1 and later, Heat is installed by default
