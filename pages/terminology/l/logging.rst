...
- `Manage Logs <http://docs.openstack.org/admin-guide-cloud/compute-manage-logs.html>`_

- `Logging and Monitoring <http://docs.openstack.org/openstack-ops/content/logging_monitoring.html>`_

- `Compute service logging <http://docs.openstack.org/admin-guide-cloud/common/support-compute.html#compute-service-logging>`_
