...
similar event.  Versions 2.1 and later of Fuel solve this problem by 
...
how Fuel 2.1 works around this problem which, in turn, you can use to 
...
Fuel 2.1 updates the ``/etc/init.d/rabbitmq-server`` init scripts for 
RHEL/Centos and Ubuntu to customized versions. These scripts attempt to 
...
So with the customized init scripts included in Fuel 2.1, in most cases 
